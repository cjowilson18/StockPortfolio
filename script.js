class Portfolio extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            ],//api JSON data uses the underscore_styled format
            form: {
                name: '',
                shares_owned:0,
                cost_per_share:0,
 ...
 handleChange(event, index) {
    ...
    removeStock(index) {
        // creates a shallow copy and tehn removes the value at the index and sets the state to the newly created portfolio
        const portfolio= this.state.portfolio.slice();
    ...
    render () {
        ...
        return (
            <div className="container">
                <h1 className="text-center my-4">Stock Portfolio With React</h1>
                <div className="row">
                                ...
                                {portfolio.map((stock,index)=> {
                                    ...
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td><button className="btn btn-light btn-sm" onClick= {() => this.removeStock(index)}>Delete</button></td>
                                        </tr>
                                    )
                                })}
                            </tbody>
